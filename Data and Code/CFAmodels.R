...
residuals(fit.2factor, type = "cor")
...
# Omega
# .972[.970, .971], se = .0052
ci.reliability(data = S2.cfa[,c("vVerbal", "vExclusion", "vPhysical", "vRelational", "vRacial", 
                                "vReligious", "vSexual", "vComp", "vCell", "vCompOut", "vCellOut")], 
               type = "categorical", 
               interval.type = "bca", 
               B = 10000, 
...
# Omega
# .965[.963, .964], se = .0038
ci.reliability(data = S2.cfa[,c("pVerbal", "pExclusion", "pPhysical", "pRelational", "pRacial", 
                                "pReligious", "pSexual", "pComp", "pCell", "pCompOut", "pCellOut")], 
               type = "categorical", 
               interval.type = "bca", 
               B = 10000, 
