...
#### Unconstrained principal axis factoring analysis ####
...
# Omega
# .986[.985,.986], se = .0063
ci.reliability(data = S1.efa[,c("vVerbal", "vExclusion", "vPhysical", "vRelational", "vRacial",
                                "vReligious", "vSexual", "vComp", "vCell", "vCompOut", "vCellOut")], 
               type = "categorical", 
               interval.type = "bca", 
               B = 10000, 
...
# Omega
# .986[.985,.986], se = .0063
ci.reliability(data = S1.efa[,c("pVerbal", "pExclusion", "pPhysical", "pRelational", "pRacial", 
                                "pReligious", "pSexual", "pComp", "pCell", "pCompOut", "pCellOut")], 
               type = "categorical", 
               interval.type = "bca", 
               B = 10000, 
